...
## 수익 모델 — v6 (2026-04-21, 솔로 운영 + 커피값 후원)

**원칙:** 매장 섭외·B2B 협업 전면 폐기. 온라인 홍보만으로 운영, 커피값 후원이 들어오면 성공. 상세는 `docs/MONETIZATION.md` 참조.

| # | 경로 | 시작 | DAU 게이트 |
|---|---|---|---|
| A | 코딩몰라 채널 (유튜브/블로그/쿠팡파트너스) | Week 1 | 없음 |
| B | 카카오페이 QR 팁잔 | Week 0 ✅ LIVE | 없음 |
| C | (조건부) 연습모드 Adsterra 배너 | Week 4+ | DAU 100+ |

**불변 원칙:** 게임플레이 유료화 금지(자발적 후원만). 광고 도입 시 쿠키 동의 + "(광고)" 표기. 로그인·결제벽 없음 유지.

법규 체크리스트는 `docs/LEGAL.md` 참조 (GRAC B2C OK · 매장/경품 트랙 폐기로 경품표시법·사행행위법 무관).

## 6주 로드맵 — v6 단일 트랙 (솔로 B2C)

한 주 = **토 00:00 ~ 금 23:59 (KST)**. advisor 검토 = 매주 화 21:00.

| Week | 기간 | 작업 |
|---|---|---|
| 0 | 2026-04-19 ~ 04-20 | ✅ 완료: 배포·팁잔·Vibe Jam 제출·Spend Alert·GRAC 1차 상담·v6 피벗 |
| 1 | **2026-04-21 ~ 05-01** (11일 확장, Vibe Jam 데드라인 정렬) | 코딩몰라 영상 1편 · Threads/Blogger 런칭 · 5/1 22:37 KST Vibe Jam 최종 잠금 |
| 2 | 2026-05-02 ~ 05-08 | (선택) Durable Object 2~10인 멀티 · 영상 2편 |
| 3 | 2026-05-09 ~ 05-15 | 리더보드 · OG 이미지 PNG 전환 · 영상 3편 |
| 4 | 2026-05-16 ~ 05-22 | (DAU 100+ 시) Adsterra 검토 · 영상 4편 |
| 5 | 2026-05-23 ~ 05-29 | 정직 리포트 블로그 · 영상 5편 |
| 6 | 2026-05-30 ~ 06-05 | 전체 KPI 공개 · GO/NO-GO 판정 · 영상 6편 |
...
│   ├── PRIVACY.md         ← 개인정보 처리방침 (최소수집 원칙)
│   ├── TERMS.md           ← 이용약관 (실력기반 플레이)
│   ├── MONETIZATION.md    ← v6 솔로 운영 수익 경로 (채널 + 팁잔)
│   ├── LEGAL.md           ← GRAC 상담 기록 (B2C OK) · 광고 시 KISA 가이드
│   └── DEPLOY.md          ← Cloudflare Pages 배포 가이드
└── server/                ← (선택) Week 2부터 멀티 서버
```
